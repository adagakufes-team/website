...
export default function ArchiveYearClient({
  archive,
}: Props) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-16">
      ...
      <section className="text-center">
        <p className="font-semibold tracking-[0.3em] text-orange-500">
          ARCHIVE
        </p>
          ...
          >
            ...
            <div className="p-8">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link
                  href={selectedExhibitor.sns}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="rounded-lg border border-orange-500 px-5 py-3 text-orange-500"
                >
                  SNS
                </Link>
              </div>
              ...
              <button
                ...
                className="mt-8 rounded-lg border px-5 py-2"
              >
                閉じる
              </button>
            </div>
